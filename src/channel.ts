...
const mcp = new Server(
  { name: 'voice', version: '0.1.0' },
  {
    ...
    instructions: [
      ...
      'Keep spoken replies to 1-3 SHORT sentences — a concise summary of your answer.',
      'For detailed or complex responses, speak a brief summary, then write the full response as text in the session so the user can read it.',
